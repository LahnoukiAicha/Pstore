      ...
      <div class="home-content">
        <div class="overview-boxes">
            <div class="box">
                ...
                <label for="prenom">Activité: </label>
                <input  value="<?= !empty($_GET['id']) ? $fournisseur['prenom'] : "" ?>"type="text" name="prenom" id="prenom" placeholder=" Veuillez saisir la prenom:">


                <label for="tele">Telephone: </label>
                <input value="<?= !empty($_GET['id']) ? $fournisseur['tele'] : "" ?>"type="text" name="tele" id="tele" placeholder=" Veuillez saisir le N° de telephone:">
