        ...
        <div class="overview-boxes">
            ...
            <div class="box"  style="display: block;">
              ...
              <div class="filter-container">
                ...
                <label for="filterCategory">Client: </label>
                <select id="filterCategory">
                     <option value="">Tous </option>
                     <?php
                         $categories = getClient();
              ...
              if(!empty($ventes)&& is_array($ventes)){
                foreach($ventes as $key=>$value){
                  ...
                  <tr>
                    ...
                    <td><?= $value['prix']?></td>
                    <td><?= date('d/m/y  ',strtotime($value['dateVente']))?></td>
                    <td>
                      <a href="reçuVente.php?id=<?= $value['id']?>"><i class='bx bx-receipt'></i></a>
                      <a href="../model/annulerVente.php?id=<?= $value['id'] ?>" style="color:red;"><i class='bx bx-trash'></i></a>
